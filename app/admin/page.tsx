...
const Groups: React.FC = (formData: FormData) => {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8" className="d-flex">
          ...
          <tbody>
            {groups.map((group) => (
              <tr key={group.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="px-6 py-4">{group.course_id}</td>
                <td className="px-6 py-4">{group.teacher_id}</td>
              </tr>
            ))}
          </tbody>
        </table>
